...
\documentclass[%
  ...
  abstract,		% Abstract Überschriften
...
% APA-Style
% Abstände für "Caption" von Bilder und Tabellen
\DeclareCaptionLabelSeparator*{spaced}{:\enskip}
\captionsetup[table]{labelfont=bf,format=plain,justification=centering,singlelinecheck=false,labelsep=spaced,skip=0pt}
\captionsetup[figure]{labelfont=bf,format=plain,justification=centering,singlelinecheck=false,labelsep=spaced}
