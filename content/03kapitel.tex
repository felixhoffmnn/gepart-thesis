...
Multidomain Daten ermöglichen es, generalisierter \ac{ML} Modelle zu trainieren. Es ist notwendig, dass unterschiedliche Datenquellen im Prozess des Data Understandings und Data Preparation individuell verarbeitet werden, da die Rohdaten stark voneinander abweichen.
...
% TODO: Ausweitung der Auswahl \autocite{biessmann_predicting_2016}

Für das \nameref{sec:modeling} werden Datensätze benötigt, deren Einträge neben den Features (z. B. Text, Alter, Geschlecht) auch eine Parteizuordnung haben. Hierfür werden Datensätze gewählt, die Daten von Politikern einer Partei beinhalten. Somit kann die Parteizugehörigkeit als Zielvariable für das Training genutzt werden.
